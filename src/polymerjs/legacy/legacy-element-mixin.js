  ...
  class LegacyElement extends legacyElementBase {
    ...
    serializeValueToAttribute(value, attribute, node) {
      this._valueToNodeAttribute(
          /** @type {Element} */ (node || this), value, attribute);
    }
    ...
    getEffectiveChildNodes() {
      return (
          /** @type {Polymer.DomApi} */ (dom$0(this)).getEffectiveChildNodes());
    }
    ...
    queryDistributedElements(selector) {
      return (
          /** @type {Polymer.DomApi} */ (dom$0(this))
              .queryDistributedElements(selector));
    }
    ...
    getContentChildNodes(slctr) {
      ...
      return content ?
          /** @type {Polymer.DomApi} */ (dom$0(content)).getDistributedNodes() :
          [];
    }
    ...
    scopeSubtree(
        container,
        shouldObserve) {  // eslint-disable-line no-unused-vars
    }
    ...
    importHref(
        ...
        onload,
        onerror,
        optAsync) {  // eslint-disable-line no-unused-vars
