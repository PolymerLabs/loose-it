...
export const useNativeCSSProperties =
    Boolean(!window.ShadyCSS || window.ShadyCSS.nativeCss);
export const useNativeCustomElements =
 ...
 */
let rootPath =
    undefined || pathFromUrl(document.baseURI || window.location.href);
